...
public class StartDiceDelegate extends StartDelegate {
    ...
    public StartDiceDelegate(Activity activity, int diceSoundKey, int hitMsgKey, int mainMsgKey, Drawable drawable, int maxNum) {
        super(activity, diceSoundKey, hitMsgKey, mainMsgKey, drawable, maxNum, new DrawViewDice(activity, activity.getWindowManager(), diceSoundKey, hitMsgKey, drawable, maxNum, false));
    }
    ...
    public StartDiceDelegate(Activity activity, int diceSoundKey, int hitMsgKey, int mainMsgKey, int linkMsgKey,
        ...
        super(activity, diceSoundKey, hitMsgKey, mainMsgKey, linkMsgKey, titleMsgKey, startMsgKey, fullVersionLinkKey,
                drawable, maxNum, new DrawViewDice(activity, activity.getWindowManager(), diceSoundKey, hitMsgKey, drawable, maxNum, true));
    }
