...
public class StartDiceDelegate extends StartDelegate {
    ...
    // Premium
    public StartDiceDelegate(Activity activity, int diceSoundKey, int hitMsgKey, int mainMsgKey, Drawable drawable, int maxNum, Integer fakeNumber) {
    ...
    public StartDiceDelegate(Activity activity, int diceSoundKey, int hitMsgKey, int mainMsgKey, int linkMsgKey,
            int titleMsgKey, int startMsgKey, int fullVersionLinkKey, Drawable drawable, int maxNum, Integer fakeNumber) {
